...
<head>
	...
	<title>Foliot | Администратор </title>
...
<div id="wrap">
 	 <div id="top-panel">
		 <div id="logo-block" href="../../">
			 <a id="invisible-link" href="../../"></a>
			 <!-- <a href="../../">
			   <img id="logo" src="img/logo.png" border="0" width="55%" height="55%" alt="На главную" />
		   </a> -->
		 </div>
		 <div id="header">
